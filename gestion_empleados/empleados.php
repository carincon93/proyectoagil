                    ...
                    while($row = mysqli_fetch_array($query)){
                        echo "
                            <tr>
                                ...
                                <td>".$row['nombre']."</td>
                                <td>
                                    <a class='icon-search btn btn-warning act' href='consultar_empleado.php?id=".$row['id_empleados']."'></a>
                                    <a class='icon-pencil btn btn-primary act' href='editar_empleado.php?id=".$row['id_empleados']."'></a>
                                    <a class='icon-bin btn btn-danger act' href='eliminar_empleado.php?id=".$row['id_empleados']."'></a>
                                </td>
                            </tr>
                        ";
                    }
