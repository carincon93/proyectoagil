    <nav class="dashboard-navbar">
        ...
        <div class="btn-group">
           <button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <li class="name-user"><?php echo $_SESSION['cliente']; ?></li>
           </button>
    ...
    <div class="navigation">
    	<nav>
            <a href="../dashboarduser/index.php" class="link <?php if ($page == 'catalogo') { echo 'active';} ?>">Catálogo de vehículos</a>
    		<a href="" class="link" data-toggle="collapse" href="#" data-target="#vehicles-toggle" aria-expanded="false" aria-controls="vehicles-toggle">Vehículos</a>
