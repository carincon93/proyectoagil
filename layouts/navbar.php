    <nav class="dashboard-navbar">
        ...
        <div class="btn-group">
            <button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><li class="name-user"><?php echo $_SESSION['administrador']; ?></li></button>
    ...
    <div class="navigation">
    	<nav>
            ...
            <a href="<?php echo $base_url; ?>/dashboardadmin/gestion_empleados/empleados.php" class="link <?php if ($page == 'gestionar_empleados') { echo 'active';} ?>">Gestionar Empleados</a>
            <a href="<?php echo $base_url; ?>/dashboardadmin/gestion_usuarios/usuarios.php" class="link <?php if ($page == 'gestionar_usuarios') { echo 'active';} ?>">Gestionar Usuarios</a>
    	</nav>
    </div>
