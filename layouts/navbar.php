 ...
 ?>
    ...
    <div class="navigation">
    	<nav>
            ...
            <a href="<?php echo $base_url; ?>/gestion_empleados/empleados.php" class="link <?php if ($page == 'gestionar_empleados') { echo 'active';} ?>">Gestionar Empleados</a>
            <a href="<?php echo $base_url; ?>/gestion_usuarios/usuarios.php" class="link <?php if ($page == 'gestionar_usuarios') { echo 'active';} ?>">Gestionar Usuarios</a>
    	</nav>
    </div>